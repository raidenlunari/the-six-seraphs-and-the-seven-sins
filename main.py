...
def meetCharacter(activator):
    ...
    def meetCarl():
        ...
        input(""); time.sleep(0.2)
        print("CARL: I received a letter from one o' my lil apprentices, DAVID, that I was gonna' be killed."); time.sleep(0.2)
        ...
        print("CARL: My apprentices were lyin' low and livin' well, my lil' DAVID was livin' comfortably."); time.sleep(0.2)
